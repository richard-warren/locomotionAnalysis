'''
initially, i found that in deepposekit left and right hind paws got swapped in top view, whereas deeplabcut didn't have
this probelm trained on the same data // here i am doing a hyperparameter sweep for deepposekit to see if any
hyperparam settings cause it to outperform dlc.
'''
