function locationsTop = getLocationsTop(potentialLocationsTop, locationsBot, frameTimeStamps, fs)
...
xOccludeBuffer = 40;  % if paws in bottom view have x values within xOccludeBuffer of one another, the paw further away from the camera is treated as occluded
