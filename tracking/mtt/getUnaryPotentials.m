function unaryPotentials = getUnaryPotentials(x, y, xyScores, frameWidth, frameHeight, anchorPointY, anchorPointX, numOccluded, unaryWeight, maxDistance)
...
unaryPotentials(abs(dx) > maxDistance) = 0;
