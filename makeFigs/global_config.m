...
m.predictors = {'modPawX', 'wiskContactPosition', 'velAtWiskContact', 'modPawZ', 'angleAtWiskContact'};  % the values in this array are determined via forward selection in the scipt baselineDecision.m
