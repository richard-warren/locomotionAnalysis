...
compareToFirstOnly = true; % if true, only do statistical comparisons between first and all other conditions
...
figure('name', figTitle, 'Color', 'white', 'MenuBar', 'none', 'Position', [2000 50 300*columns 300*rows], 'inverthardcopy', 'off')
...
if addStats
    ...
    if compareToFirstOnly; conditionPairs = conditionPairs(any(conditionPairs==1,2),:); end % only keep comparisons between first and all other conditions
