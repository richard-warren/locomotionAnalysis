...
% heatmaps
plotDecisionHeatmaps(data, 'condition', 'sensoryCondition', 'levels', vars.sensoryCondition.levels, ...
    'successOnly', successOnly, 'modPawOnlySwing', modPawOnlySwing, 'lightOffOnly', lightOffOnly, ...
    'avgMice', true, 'plotMice', true, 'colors', sensColors, ...
    'saveLocation', fullfile(getenv('OBSDATADIR'), 'papers', 'hurdles_paper1', 'figures', 'matlabFigs', 'sensoryDependenceHeatmaps'));

% trials scatters
plotDecisionTrials(data, 'condition', 'sensoryCondition', 'levels', vars.sensoryCondition.levels, ...
    'successOnly', successOnly, 'modPawOnlySwing', modPawOnlySwing, 'lightOffOnly', lightOffOnly, ...
...
%% model accuracies
plotModelAccuracies(data, 'condition', 'sensoryCondition', 'levels', vars.sensoryCondition.levels, ...
    'predictDirection', true, 'successOnly', false, 'modPawOnlySwing', true, 'lightOffOnly', false, ...
...
%% decision threshold
plotDecisionThresholds(data, 'condition', 'sensoryCondition', 'levels', vars.sensoryCondition.levels, ...
    'successOnly', successOnly, 'modPawOnlySwing', modPawOnlySwing, 'lightOffOnly', lightOffOnly, ...
