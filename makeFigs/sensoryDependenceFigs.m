...
plotModelAccuracies(flat, m.predictors, 'isModPawLengthened', ...
    ...
    'balanceClasses', true, 'deltaMin', m.deltaMin, 'successOnly', m.successOnly, 'modPawOnlySwing', m.modPawOnlySwing, 'lightOffOnly', m.lightOffOnly, ...
    'shuffledConditions', [1 2], 'colors', [sensColors; .2 .2 .2], 'barProps', barProperties, ...
