...
highPass = 300;
fs = 30000;
folder = 'Y:\obstacleData\sessions\180917_002\2018-09-17_15-46-56';
yLims = [-500 500];
windowSize = .5;
timeIntervals = 5*60;
...
[~, times] = load_open_ephys_data_faster(fullfile(folder, '100_CH1.continuous'));
...
for i = 1:length(channels)
    ...
    [data, times, info] = load_open_ephys_data_faster(fullfile(folder, ['100_CH' num2str(channels(i)) '.continuous']));
