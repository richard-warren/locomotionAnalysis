...
barFancy(squeeze(corrs(1,1,:,:)), 'levelNames', {vars.sensoryCondition.levelNames}, 'ylabel', 'paw-obstacle correlation', ...
...
logPlotRick(obsHgts(lfBins), pawHgts(lfBins), ...
    'colors', sensColors, 'conditions', conditions(lfBins), 'xlabel', 'obstacle height (mm)', 'ylabel', 'paw height (mm)', 'plotMice', false, ...
