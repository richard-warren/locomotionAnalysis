...
% initializations
figure('units', 'inches', 'position', [3.83 3.61 7.5 figHgt], 'color', 'black', 'menubar', 'none', 'inverthardcopy', false)
yLims = [0 .8];
...
logPlotRick([flat_sub.obsHgt]*1000, [flat_sub.preObsHgt]*1000, ...
    {'colors', pawColors, 'conditions', [flat_sub.stepType], 'xlabel', 'obstacle height', 'ylabel', 'paw height (mm)',  ...
