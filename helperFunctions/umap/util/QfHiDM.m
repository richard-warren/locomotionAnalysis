...
classdef QfHiDM < handle
    ...
    methods(Static)
        ...
        function swb=BackgroundReadings(sayBackground, tb)
            app=BasicMap.Global;
            if app.highDef
                factor=1.2;
            else
            ...
            swb.add(lbl);
            lbls={...
                ['<html>' Html.ImgXy('epp.png', [], factor) ...
                sm1 '&nbsp;&nbsp;MDS, Epp &amp; phenograms' sm2 '</html>'], ...
                ['<html>' Html.ImgXy('match16.png', [], factor) ...
                sm1 '&nbsp;&nbsp;QFMatch' sm2 '</html>'], ...
                ['<html>' Html.ImgXy('emd.png', [], factor) ...
                sm1 '&nbsp;&nbsp;Earth mover''s distance' sm2 '</html>']};
            
            combo=Gui.Combo(lbls, dflt, '',[],@(h,e)lookup(h), ...
                'Read background material on this');
            swb.add(combo);
