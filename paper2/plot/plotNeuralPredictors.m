function fig = plotNeuralPredictors(session, varargin)
...
s.predictorList = {};
s.visible = 'on';  % whether figure is visible
...
fig = figure('name', session, 'color', 'white', 'position', [125.00 93.00 1666.00 886.00], 'visible', s.visible); hold on
