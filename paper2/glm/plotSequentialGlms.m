function plotSequentialGlms(session, neuron, varargin)
% plots true and predicted firing rate for glms with successively more
% predictors
...
colors = [.4 .4 .4; .4 .4 1];                % true firing rate, predicted
...
load(fullfile(folder, 'glms', 'sequential_glms', [session '_cell_' num2str(neuron) '_glm.mat']), 'models', 'fitdata');
